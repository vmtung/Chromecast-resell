;(function() {
  ...
  ;(showStartGameUI = function() {
    const btnStartGamePos = 0.52 // 0.618
    // const gametitle_height = 10
    // console.log('particleSystem', particleSystem)
    // assetsManager.gametitle.width = window.screen.availWidth
    // assetsManager.gametitle.height = window.screen.availHeight *  149 / 523
    const scale_gametitle = gameWidth / assetsManager.gametitle.width
    console.log('scale_gametitle', scale_gametitle)
    
    const SppImg_gametitle = function() {
      SPP.SpriteImage.call(this)
    }
    SppImg_gametitle.prototype = SPP.inherit(SPP.SpriteImage.prototype)
    SppImg_gametitle.prototype.reset = function() {
      // SPP.SpriteImage.prototype.reset.apply(this);
      this.texture = this.context = null;
      this.scale = scale_gametitle;
      this.rotation = 0;
      this.alpha = 1;
      this.regY = this.regX = 0.5
  }

    // assetsManager.gametitle.style.cssText = 'object-fit:cover'
    // console.log('assetsManager.gametitle', assetsManager.gametitle)
    ;(gameState = GAME_READY),
      (ui_gameTitle = particleSystem.createParticle(SppImg_gametitle)),
...
function loadAssets() {
  ...
  assetsManager.start();
  // console.log('loadAssets', assetsManager)
