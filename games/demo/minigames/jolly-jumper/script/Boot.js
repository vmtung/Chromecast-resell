        ...
        init: function(){
            ...
            if (this.game.device.desktop){
                ...
                this.scale.setMinMax(
                  250,
                  380,
                  window.innerWidth > window.innerHeight * 0.6 ? window.innerHeight * 0.6 : window.innerWidth,
                  window.innerWidth > window.innerHeight * 0.6 ? window.innerHeight : window.innerWidth / 0.6
                );       
